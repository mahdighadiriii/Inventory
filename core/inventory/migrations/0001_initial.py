# Generated by Django 4.2 on 2024-08-20 17:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('data_center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='inventory.datacenter')),
            ],
        ),
        migrations.CreateModel(
            name='Rack',
            fields=[
                ...
                ('data_center', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.datacenter')),
            ],
        ),
        migrations.CreateModel(
            name='Power',
